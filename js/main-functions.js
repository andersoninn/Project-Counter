...
document.querySelector('[type=submit]').addEventListener('click', () => {
    ...
    //SUPERMARKET-BILLS
     ...
     var vitorSupMFinal = (supMTotalValue - supMVitorValue - supMAndYasValue)/3 + supMVitorValue
    //  console.log(`O valor do Vitor é ${vitorSupMFinal.toFixed(2)}`);

    var AndYasSupMFinal = ((supMTotalValue - supMAndYasValue - supMVitorValue)/3)*2 + supMAndYasValue
    // console.log(`o valor And/Yas é ${AndYasSupMFinal.toFixed(2)}`);

    var finalAndYas = (finalValue1)*2 + andIndBills + yasIndBills + AndYasSupMFinal;
