...
setTimeout(function () {
  ...
  vitor.innerHTML =
    'Oferencendo carne ao Vitor .&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.';
...
setTimeout(function () {
  ...
  yasmim.innerHTML =
    'Arrumando as bagunças da Yasmim&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.';
...
setTimeout(function () {
  ...
  chiriba.innerHTML =
    'Fazendo carinho na Chiriba .&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.&nbsp&nbsp.';
