...
var ValueBills = document.querySelectorAll('.fixed-bills input')
// console.log (ValueBills)
var output1 = document.querySelectorAll('#output')
console.log(output1)


ValueBills.forEach(element => adicionar(){
     function adicionar(){ 
        output1.addEventListener('change', ()=>{ 
            output1 = element.NextSibling.value / 3
        })
    }
    console.log(output1)
